...
Auto-synced with dbt models via allowed_tables.json generated by dbt run.
"""
...
class SchemaContext:
    ...
    def _load_allowed_tables(self) -> list:
        """
        Load allowed tables from JSON file generated by dbt/scripts/generate_ai_schema.py.
        Falls back to default list if file not found.
        """
        json_path = Path(__file__).parent / 'allowed_tables.json'
        
        default_tables = [
            'mart_sales', 'mart_customer_analytics', 'mart_product_analytics',
            'mart_operations', 'mart_employee_territory_performance', 'mart_metrics',
    ...
    def get_table_schemas(self) -> dict:
        ...
        # Load priority tables from auto-generated JSON (synced with dbt)
        priority_tables = self._load_allowed_tables()
...
ORDER BY total_value DESC"""
            ...
            (
                "Show me all metrics and their values",
...
LIMIT 100"""
            ...
            (
                ...
                """SELECT metric_name, metric_value, metric_unit, metric_target
FROM mart_metrics
...
ORDER BY metric_name"""
            ...
            (
                ...
                """SELECT m.metric_name, m.metric_value, dt.territory_name, dp.product_name
FROM mart_metrics m
LEFT JOIN dim_territory dt ON m.territory_key = dt.territoryid
LEFT JOIN dim_product dp ON m.product_key = dp.productid
...
"""
    ...
    def get_quick_context(self) -> str:
        ...
        """
        return """Tables: mart_sales (main), mart_customer_analytics, mart_product_analytics, mart_operations, mart_employee_territory_performance, mart_metrics
...
mart_metrics: ⭐ USE FOR ALL METRIC QUERIES! metric_name, metric_category, metric_value, metric_unit, metric_target, report_date
