...
class SQLValidator:
    ...
    # Default allowed tables (fallback if allowed_tables.json not found)
    ...
    def __init__(self, strict_mode: bool = True):
        ...
        # Load allowed tables from generated JSON file (auto-synced with dbt)
    ...
    def _load_allowed_tables(self) -> list:
        ...
        Falls back to DEFAULT_ALLOWED_TABLES if file not found.
        """
        ...
        # Fallback to default
        return [t.lower() for t in self.DEFAULT_ALLOWED_TABLES]
